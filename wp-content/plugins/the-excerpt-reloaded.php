...
//	$output = str_replace(array("\r\n", "\r", "\n", "  "), " ", $output);
	...
	if ($use_more_link && $more_link_text) {
		if($force_more) {
			$output .= '<span class="read-more"><a href="'. get_permalink($post->ID) . '#more-' . $post->ID .'" title="' . $more_link_title . '">' . $more_link_text . '</a></span>' . "\n";
		} else {
			$output .= '<span class="read-more"><a href="'. get_permalink($post->ID) . '" title="' . $more_link_title . '">' . $more_link_text . '</a></span>' . "\n";
		}
	}
